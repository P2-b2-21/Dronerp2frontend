...
let frontendAddr = developmentMode ? "127.0.0.1:5500" : "server.malthelarsen.dk";
let backendAddr = developmentMode ? "127.0.0.1:3000" : "server.malthelarsen.dk:3000";
...
function postFinalARC() {
    ...
    postObjectToServer('ARCGRC', objToSend).then(() => {
